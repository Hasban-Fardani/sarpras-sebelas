...
<template>
    <user-edit-dialog 
        :user-prop="selectedEditUser" 
        :is-active="editUserDialog"
    ...
    <v-data-table-server 
        ...
        :items-length="userTable.total" 
        :loading="userTable.onUpdate" 
        :search="userTable.searchName"
        item-value="name" 
        @update:options="userTable.updateTable"
    >
